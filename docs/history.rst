...
That was the beginning. I found and forked a tiny `wiki system <https://github.com/alexex/wiki>`_ based on Flask and sent a first `pull request <https://github.com/alexex/wiki/pull/30>`_ where I explained few of my motivations:
...
During those days, I started to take a lot of design decisions and commit a bunch of code, so my fork diverge too much from Alex's wiki. That's how the `original version of Waliki <https://github.com/mgaitan/waliki_flask/>`_ was born.
