...
It registers a new :ref:`extra_page_action view <write_plugin>` in the dropdown menu as *"View as slides"*. For obvious reasons, it only appear in reStructuredText pages.
