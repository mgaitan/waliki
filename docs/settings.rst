...
.. confval:: WALIKI_ALLOW_TAGS

   .. versionadded:: 1.3

   If installed (wich is highly recommended), the HTML generated by Waliki is sanitized using `bleach <http://bleach.readthedocs.org/>`_.
   This config is the *white list* of tags. Default is

   .. code-block::

       ['a','abbr','acronym','b','blockquote','code','em','i','li','ol','strong','ul','h1','h2','h3','h4','h5','h6','hr', 'img',
